...
async function startRecording() {
  ...
  try {
    ...
    mediaRecorder.onstop = () => {
      ...
      recordButton1.classList.remove("text-danger", "bi-mic-mute-fill");
      recordButton1.classList.add("bi-mic-fill");
    ...
    recordButton1.classList.remove("bi-mic-fill");
    recordButton1.classList.add("text-danger", "bi-mic-mute-fill");
    recordButton1.classList.add("recording"); // Agregar la clase "recording"
  } catch (error) {
